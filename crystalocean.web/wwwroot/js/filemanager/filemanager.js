$(document).ready(function() {
    ...
    $("#input-ke-1").fileinput({
        ...
        initialPreviewConfig: [
            { 
                caption: "Business 1.jpg", 
                size: 762980, 
                url: "/site/file-delete", 
                downloadUrl: 'http://lorempixel.com/800/460/business/1', 
                key: 11
            },
            {
                previewAsData: false, 
                size: 823782, 
                caption: "Business 2.jpg", 
                url: "/site/file-delete", 
                downloadUrl: 'http://lorempixel.com/800/460/business/2', 
                key: 13
            }, 
            {
